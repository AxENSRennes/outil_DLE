        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "rules",
                    models.JSONField(
                        blank=True, default=dict, help_text="Conditional composition rules (JSONB)."
                    ),
                ),
                (
                    "elements",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("box_level_control", "Box-level control"),
                ...
                (
                    "applicability",
                    models.CharField(
                        choices=[("required", "Required"), ("not_applicable", "Not applicable")],
                        default="required",
                        max_length=20,
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="exports.batchdossierstructure",
                    ),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["structure", "display_order"], name="exports_de_struct_order_idx"
                    )
                ],
                "constraints": [
