...
class TestSubmitCorrectionHappyPath:
    def test_correction_on_in_progress_step_succeeds(
    ...
    def test_correction_on_complete_step_succeeds(
        self, batch: Batch, actor: Any, site: Site
    ) -> None:
    ...
    def test_correction_on_signed_step_succeeds(self, batch: Batch, actor: Any, site: Site) -> None:
    ...
    def test_old_value_captured_in_audit_metadata(
        self, batch: Batch, actor: Any, site: Site
    ) -> None:
        step = _make_step(batch, StepStatus.IN_PROGRESS, {"temperature": "22.5"})
    ...
    def test_multiple_field_corrections_applied_atomically(
        self, batch: Batch, actor: Any, site: Site
    ) -> None:
        step = _make_step(
            batch,
    ...
    def test_audit_event_has_correct_target_fields(
        self, batch: Batch, actor: Any, site: Site
    ) -> None:
        step = _make_step(batch, StepStatus.IN_PROGRESS, {"temperature": "22.5"})
    ...
    def test_audit_event_metadata_contains_required_keys(
        self, batch: Batch, actor: Any, site: Site
    ) -> None:
        step = _make_step(batch, StepStatus.IN_PROGRESS, {"temperature": "22.5"})
    ...
    def test_audit_event_actor_matches_provided_actor(
        self, batch: Batch, actor: Any, site: Site
    ) -> None:
        step = _make_step(batch, StepStatus.IN_PROGRESS, {"temperature": "22.5"})
...
class TestSubmitCorrectionValidation:
    ...
    def test_empty_reason_for_change_raises_value_error(
        self, batch: Batch, actor: Any, site: Site
    ) -> None:
        step = _make_step(batch, StepStatus.IN_PROGRESS)
    ...
    def test_empty_corrections_list_raises_value_error(
        self, batch: Batch, actor: Any, site: Site
    ) -> None:
        step = _make_step(batch, StepStatus.IN_PROGRESS)
